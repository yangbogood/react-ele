  ...
  render() {
    return (
      <div className="msite">
        <Header
          signUp={true}
          title={this.state.msiteTitle}
          goBack={this.toSearch}
          icon={"search"}
          goHome={this.goHome}
        ></Header>
                      ...
                      {item.map((obj) => {
                        const path = {
                          ...
                          query: {
                            ...
                            restaurant_category_id: this.getCategoryId(
                              obj.link
                            ),
                            title: obj.title,
                          },
                        ...
                        return (
                          ...
                          >
                            <img
                              src={this.state.imgPath + obj.image_url}
                              alt=""
                            />
                            <span>{obj.title}</span>
                          </div>
                  ...
                  <Link to={"/shop/" + `${item.id}`}>
                    ...
                    <hgroup className="shop_right">
                      <header className="shop_detail_header">
                        <h4 className="shop_title ellipsis premium">
                          {item.name}
                        </h4>
